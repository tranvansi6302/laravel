...
@section('content')
    <section class="d-flex justify-content-center w-100">
        <div class="w-50">
            <h2 class="text-secondary mb-3">Sửa Users</h2>
            @if ($errors->any())
            ...
            <form action="{{ route('users.update') }}" method="POST">
                ...
                <div class="">
                    ...
                    <input value="{{ old('fullname') ?? $userDetail->fullname }}" name="fullname" id="fullname"
                ...
                <div class="mt-2">
                    ...
                    <input value="{{ old('email') ?? $userDetail->email }}" name="email" id="email"
                ...
                <div class="d-flex align-items-center gap-3 mt-4">
                    <button class="btn btn-success" type="submit">Sửa người dùng</button>
