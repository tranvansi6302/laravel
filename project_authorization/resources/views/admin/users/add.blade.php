        ...
        <div class="col-lg-6 col-md-12">
            <form action="{{ route('admin.users.add') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ old('email') }}" type="text" class="form-control @error('email') is-invalid @enderror" id="email"
                ...
                <div class="form-group">
                    ...
                    <x-validate-error :errors="$errors->get('password')" />
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select @error('group_id') is-invalid @enderror" id="group"
                        ...
                        @forelse ($groups as $group)
                            <option {{ old('group_id')==$group->id ?'selected':false }} value="{{ $group->id }}">{{ $group->name }}</option>
                        @empty
